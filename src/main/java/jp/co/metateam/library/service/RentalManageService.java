...
public class RentalManageService {
    ...
    public long countByStockIdAndStatusIn(String stockId) {
        ...
        return this.rentalManageRepository
                .countByStockIdAndStatusIn(stockId);
    }

    @Transactional
    public long countByStockIdAndStatusInAndIdNot(
            String stockId,
            Long id) {

        return this.rentalManageRepository
                .countByStockIdAndStatusInAndIdNot(
                        stockId,
                        id);
    }

    @Transactional
    public long countByStockIdAndStatusAndTermsIn(
            String stockId,
            Date expectedReturnOn,
            Date expectedRentalOn) {

        return this.rentalManageRepository
                .countByStockIdAndStatusAndTermsIn(
                        stockId,
                        expectedReturnOn,
                        expectedRentalOn);
    }
    ...
    @Transactional
    public long countByStockIdAndStatusAndIdNotAndTermsIn(
            String stockId,
            Long id,
            Date expectedReturnOn,
            Date expectedRentalOn) {
        ...
        return this.rentalManageRepository
                .countByStockIdAndStatusAndIdNotAndTermsIn(
                        stockId,
                        id,
                        expectedReturnOn,
                        expectedRentalOn);
    ...
    public void save(RentalManageDto rentalManageDto)
        ...
        Stock stock = this.stockRepository
                .findById(
        ...
        rentalManage = setRentalStatusDate(
                rentalManage,
                rentalManageDto.getStatus());
        ...
        this.rentalManageRepository.save(
                rentalManage);
    }
    ...
    private RentalManage setRentalStatusDate(
